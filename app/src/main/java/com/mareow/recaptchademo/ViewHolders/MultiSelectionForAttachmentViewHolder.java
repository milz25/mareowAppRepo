...
public class MultiSelectionForAttachmentViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{

    public AppCompatCheckBox checkBoxItem;
    RecyclerViewClickListener mListener;
    public MultiSelectionForAttachmentViewHolder(@NonNull View itemView, RecyclerViewClickListener mListener) {
        super(itemView);
