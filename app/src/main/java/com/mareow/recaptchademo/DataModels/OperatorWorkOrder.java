...
public class OperatorWorkOrder {
    ...
    @Expose
    private OperatorMachine machine;
    ...
    public OperatorMachine getMachine() {
        return machine;
    }

    public void setMachine(OperatorMachine machine) {
    ...
    public String getSupervisorStartDateStr() {
        return supervisorStartDateStr;
    }

    public void setSupervisorStartDateStr(String supervisorStartDateStr) {
    ...
    public String getSupervisorEndDateStr() {
        return supervisorEndDateStr;
    }

    public void setSupervisorEndDateStr(String supervisorEndDateStr) {
