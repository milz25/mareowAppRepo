...
public class PaymentBankDialogAdapter extends RecyclerView.Adapter<PaymentCustomeDialogViewHolder> {

    Context context;
    List<String> mHeadingData;
    List<String> mValueData;
    boolean b;
    public PaymentBankDialogAdapter(Context context, List<String> mHeadingData, List<String> mValueData, boolean b) {
