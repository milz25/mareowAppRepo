 ...
 * Use the {@link OperatorDashBoradFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class OperatorDashBoradFragment extends Fragment {
    ...
    public OperatorDashBoradFragment() {
     ...
     * @return A new instance of fragment OperatorDashBoradFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static OperatorDashBoradFragment newInstance(String param1, String param2) {
        OperatorDashBoradFragment fragment = new OperatorDashBoradFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_operator_dash_borad, container, false);
        initView(view);
    ...
    public void callFuelCountForOperator(){
        Call<String> fuelCount=apiInterface.getFuelCount("Bearer "+token,partyId);
        fuelCount.enqueue(new Callback<String>() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
                if (response.isSuccessful()){
                    String data=response.body().toString();
                    dataKeyInteger.add(data);
                    dataKeyString.add("Fuel (Ltrs)");
                    dataKeyImages.add("fuel_count");
        ...
        associatedOwner.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                if (response.isSuccessful()){
                    String data=response.body().toString();
                    dataKeyInteger.add(data);
                    dataKeyString.add("Associated with");
                    dataKeyImages.add("association_final");
                    callOperatorMachineRunCount();
                }else {
                    if (response.code()==401){
                        if (progressDialog!=null)
