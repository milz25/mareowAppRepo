...
public class DownloadService extends IntentService{
    ...
    ArrayList<OfferWorkOrder> workOrder=new ArrayList<>();
    ...
    protected void onHandleIntent(Intent intent) {
       ...
       /* notificationManager = (NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
        ...
        workOrder=(ArrayList<OfferWorkOrder>) bundle.getSerializable("workorder");
        ...
        fileName="Agreement_"+workOrder.get(0).getWorkorderDTO().getWorkOrderNo()+"_"+sdf.format(dt).toString()+".pdf";
    ...
    private void initDownload(){
        ...
        Call<ResponseBody> request = apiInterface.downloadAgreementPDF("Bearer "+ TokenManager.getSessionToken(),workOrder.get(0).getWorkorderDTO().getWorkOrderId());
    ...
    private void sendIntent(Download download){
        Intent intent = new Intent(RenterWorkOrderAdapter.MESSAGE_PROGRESS);
