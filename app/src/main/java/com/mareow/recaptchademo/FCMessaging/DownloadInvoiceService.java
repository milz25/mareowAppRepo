...
public class DownloadInvoiceService extends IntentService {

    private NotificationCompat.Builder notificationBuilder;
    private NotificationManager notificationManager;

    private int totalFileSize;
    ArrayList<InvoiceByUser> invoiceByUsers=new ArrayList<>();
    ProgressDialog pDialog;
    String fileName=null;


    public DownloadInvoiceService() {
        super("Download Invoice Service");
    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        invoiceByUsers=(ArrayList<InvoiceByUser>) bundle.getSerializable("invoice");
        ...
        fileName="Invoice_"+invoiceByUsers.get(0).getInvoiceNo()+"_"+sdf.format(dt)+".pdf";
    ...
    private void initDownload(){
        ...
        Call<ResponseBody> request = apiInterface.downloadInvoicePDF("Bearer "+token,invoiceByUsers.get(0).getInvoiceId());
        try {
    ...
    private void sendIntent(Download download){
        Intent intent = new Intent(PaymentDetailsAdapter.MESSAGE_INVOICE);
        intent.putExtra("download",download);
        LocalBroadcastManager.getInstance(DownloadInvoiceService.this).sendBroadcast(intent);
    }
